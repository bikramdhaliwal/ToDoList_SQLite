...
public class MyToDoContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.assignment2_part2s";
    ...
    private void checkColumns(String[] projection) {
        String[] available = { ToDoTableHandler.COLUMN_DESIGNATION,
                ToDoTableHandler.COLUMN_FIRSTNAME, ToDoTableHandler.COLUMN_LASTNAME,
                ToDoTableHandler.COLUMN_ADDRESS,
                ToDoTableHandler.COLUMN_PROVINCE,
                ToDoTableHandler.COLUMN_COUNRTY,
                ToDoTableHandler.COLUMN_POSTALCODE,
